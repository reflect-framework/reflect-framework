...
class GregorianCalendarTransform implements Transform<GregorianCalendar> {
	...
	/**
	 * Constructor for the <code>GregorianCalendarTransform</code> object. This is used to create a transform using a default date format pattern. The format chosen for the default date uses <code>2007-05-02 12:22:10.000 GMT</code> like dates.
	 */
	...
	/**
	 * Constructor for the <code>GregorianCalendarTransform</code> object. This is used to create a transform using a default date format pattern. The format should typically contain enough information to create the date using a different locale or time zone between read and write operations.
	 * 
	 * @param type
