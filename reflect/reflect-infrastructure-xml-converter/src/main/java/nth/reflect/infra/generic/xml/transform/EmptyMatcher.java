...
/**
 * The <code>EmptyMatcher</code> object is used as a delegate type that is used when no user specific matcher is specified. This ensures that no transform is resolved for a specified type, and allows the normal resolution of the stock transforms.
 * 
