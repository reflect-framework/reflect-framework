...
class ArrayTransform implements Transform {
	...
	/**
	 * Constructor for the <code>PrimitiveArrayTransform</code> object. This is used to create a transform that will create primitive arrays and populate the values of the array with values from a comma separated list of individula values for the entry type.
	 * 
	 * @param delegate
