...
/**
 * The <code>EnumTransform</code> represents a transform that is used to transform enumerations to strings and back again. This is used when enumerations are used in comma separated arrays. This may be created multiple times for different types.
 * 
...
class EnumTransform implements Transform<Enum> {
	...
	/**
	 * Constructor for the <code>EnumTransform</code> object. This is used to create enumerations from strings and convert them back again. This allows enumerations to be used in arrays.
	 * 
	 * @param type
