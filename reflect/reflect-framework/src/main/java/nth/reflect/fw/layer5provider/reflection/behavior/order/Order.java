 ...
 * sequenceNumbers so that you do not have to renumber all the existing
 * {@link Order} annotations every time you add a new class member in between.
 * Otherwise you can always fall back on using decimals (e.g. 1.5 or 10.25).
 * </p>
 * 
 * @author nilsth
 *
