...
public class LocalDateTimeStringConverterTest extends StringConverterTest {
	...
	public void testToString_givenNullWithNullFormat_mustReturnEmptyString() {
		LocalDateTimeStringConverter localLocalDateStringConverter = new LocalDateTimeStringConverter(NO_FORMAT);
	...
	public void testFromString_givenNull_mustReturnNull() {
		LocalDateTimeStringConverter localDateStringConverter = new LocalDateTimeStringConverter(NO_FORMAT);
