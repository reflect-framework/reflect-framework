...
import nth.reflect.util.random.generator.address.CityRepository;
import nth.reflect.util.random.generator.address.CountryRepository;
import nth.reflect.util.random.generator.address.StreetNameRepository;
import nth.reflect.util.random.generator.name.ColorNameRepository;
import nth.reflect.util.random.generator.name.CompanyNameRepository;
import nth.reflect.util.random.generator.name.DomainNameRepository;
import nth.reflect.util.random.generator.name.FemaleNameRepository;
import nth.reflect.util.random.generator.name.LastNameRepository;
import nth.reflect.util.random.generator.name.MaleNameRepository;
import nth.reflect.util.random.generator.name.ProductRepository;
import nth.reflect.util.random.generator.word.LoremIpsumRepository;
