 ...
 * use or extend one of the {@link ReflectProviderProjects} that come with
 ...
 * {@link Provider} by overwriting the matching {@link ReflectApplication#get
 * ...ProviderClass()} method.
 * </p>
 * <p>
 * The following sections will describe the optional
 * {@link ReflectProviderProjects} that come with the
