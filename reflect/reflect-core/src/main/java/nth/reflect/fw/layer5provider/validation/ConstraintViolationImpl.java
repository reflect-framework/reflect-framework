...
public class ConstraintViolationImpl<T> implements ConstraintViolation<T>, Serializable {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((this.leafBean == null) ? 0 : this.leafBean.hashCode());
		result = prime * result + ((this.message == null) ? 0 : this.message.hashCode());
		result = prime * result + ((this.propertyPath == null) ? 0 : this.propertyPath.hashCode());
		result = prime * result + ((this.rootBean == null) ? 0 : this.rootBean.hashCode());
	...
	/**
	 * {@inheritDoc} NOTE: Needed to avoid duplication in the reported
	 * violations.
	 * 
	 * @param obj
