...
/**
 * <p>
 * The {@link IntrospectFramework} favors constructor injection (see <a
 ...
 * </p>
 * <p>
 * All objects within an {@link IntrospectApplication} can have references to
 ...
 * <ul>
 * <li>The IntrospectApplication class can be injected in all layers</li>
 * <li>You can only inject objects of the same layer or lower layers (see
 * {@link IntrospectArchitecture}). The {@link IntrospectFramework} tries to
 ...
 * {@link IntrospectApplication} by overriding the get...Classes() or
