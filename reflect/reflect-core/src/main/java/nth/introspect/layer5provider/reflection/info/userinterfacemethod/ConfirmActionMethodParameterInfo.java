...
/**
 * A {@link ConfirmActionMethodParameterInfo} is a method in the
 ...
 * {@link ConfirmActionMethodParameterInfo}s that have different parameter
 * types.
 * 
 * @author nilsth
 *
...
public class ConfirmActionMethodParameterInfo {
	...
	private final Method confirmActionMethodParameterMethod;

	public ConfirmActionMethodParameterInfo(
			Class<? extends UserInterfaceController> userInterfaceControllerClass,
			ActionMethodInfo methodInfo) {
		this.methodInfo = methodInfo;
		this.confirmActionMethodParameterMethod = getConfirmActionMethodParameterMethod(userInterfaceControllerClass);
	}

	private Method getConfirmActionMethodParameterMethod(
			Class<? extends UserInterfaceController> userInterfaceControllerClass) {
	...
	private Method findMethod(
		...
		try {
			Method method = userInterfaceControllerClass.getClass().getMethod(
	...
	public void invoke(Object userInterfaceController, Object methodOwner,
		...
		Object[] parameterValues = getProcessMethodParameterValues(methodOwner,
				methodParameter);
		confirmActionMethodParameterMethod.invoke(userInterfaceController,
				parameterValues);
	}
