...
public class ValidationProviderTest {
	...
	public void jsr303Validation_isNull() {
		...
		Set<ConstraintViolation<Object>> constraintViolations = validationProvider.validate(car);
	...
	public void validationMethodForClass_AddressExists() {
		...
		Set<ConstraintViolation<Object>> constraintViolations = validationProvider.validate(address);
	...
	public void validationMethodForClass_AddressNotExists() {
		...
		assertEquals(1, constraintViolations.size());
		assertEquals("address does not exist", constraintViolations.iterator().next().getMessage());
	}
	...
	public void validationMethodForPropertyClass_BadZipCode() {
		...
		assertEquals(1, constraintViolations.size());
		assertEquals("must contain 4 numbers followed by 2 letters",
