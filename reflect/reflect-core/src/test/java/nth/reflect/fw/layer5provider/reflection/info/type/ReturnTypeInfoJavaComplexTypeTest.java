...
public class ReturnTypeInfoJavaComplexTypeTest {

	private ReflectApplicationForJUnit application;
	private TypeInfo typeInfo;

	public Integer theMethod() {
	...
	public void testGetType() {
		Assert.assertThat(typeInfo.getType(), equalTo(Integer.class));

	}

	@Test
	public void testGetGenericType() {
		Assert.assertThat(typeInfo.getGenericType(), equalTo(Integer.class));
	}
