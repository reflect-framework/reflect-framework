...
public class ReturnTypeInfoVoidTypeTest {
	...
	public void testGetType() {
		Assert.assertThat(typeInfo.getType(), equalTo(void.class));

	}

	@Test
	public void testGetGenericType() {
		Assert.assertThat(typeInfo.getGenericType(), equalTo(void.class));
	}
	...
	public void testIsVoid() {
		Assert.assertThat(typeInfo.isVoid(), equalTo(true));
	}
