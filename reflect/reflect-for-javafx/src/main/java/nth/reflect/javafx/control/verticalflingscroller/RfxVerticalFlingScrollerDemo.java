...
public class RfxVerticalFlingScrollerDemo extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		new RfxVerticalFlingScroller(list);

		
		final Scene scene = new Scene(list, 600, 600, Color.WHITE);
		stage.setTitle("JFX ListView Demo ");
//		scene.getStylesheets().add(RfxVerticalFlingScrollerDemo.class.getResource("/resources/css/jfoenix-components.css").toExternalForm());
