...
public class JFoenixTabTest extends Application {
...
//		scene.getStylesheets().add(JFoenixTabTest.class.getResource("/resources/css/jfoenix-components.css").toExternalForm());
