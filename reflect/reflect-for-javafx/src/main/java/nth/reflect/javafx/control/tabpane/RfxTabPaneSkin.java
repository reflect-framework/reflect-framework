 ...
 */
public class RfxTabPaneSkin extends BehaviorSkinBase<TabPane, TabPaneBehavior> {
	...
	public RfxTabPaneSkin(TabPane tabPane, MaterialStyle materialStyle) {
		super(tabPane, new TabPaneBehavior(tabPane));
		
		defaultColor = RfxColorFactory.create(materialStyle.getApplicationToolbarStyle().getBackgroundColor());
		ripplerColor = RfxColorFactory.create(materialStyle.getApplicationToolbarIconStyle().getPressedColor());
		selectedTabText = RfxColorFactory.create(materialStyle.getApplicationToolbarIconStyle().getColor());
		tempLabelColor = RfxColorFactory.create(materialStyle.getApplicationToolbarIconStyle().getColor());
	...
	protected class HeaderContainer extends StackPane {
		...
		public HeaderContainer() {
			...
			selectedTabLine.setStroke(selectedTabText);
