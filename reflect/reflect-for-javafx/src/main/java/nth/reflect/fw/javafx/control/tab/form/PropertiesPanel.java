...
public class PropertiesPanel extends VBox {
	...
	public PropertiesPanel(FormTab formTab) {
		super();
...
//	}
	...
	private PropertyPanel createPropertyPanel(FormTab formTab, BufferedDomainValueModel domainValueModel, FormMode formMode,
