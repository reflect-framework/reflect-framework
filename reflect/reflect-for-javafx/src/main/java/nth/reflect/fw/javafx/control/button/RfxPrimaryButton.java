...
/**
 * {@link RfxControl} button in the primary color, see
...
public class RfxPrimaryButton extends RfxContentButton implements RfxControl {
	...
	public static void appendStyleGroups(RfxStyleSheet styleSheet) {
		...
		// rippler color
		styleSheet.addStyleGroup(RfxStyleSelector.createFor(RfxPrimaryButton.class).appendChild("jfx-rippler"))
				.getProperties().put("-jfx-rippler-fill", ReflectColorName.PRIMARY.BACKGROUND_20());
		// icon color
		styleSheet.addStyleGroup(RfxStyleSelector.createFor(RfxPrimaryButton.class).appendChild(RfxFontIcon.class))
