...
public class TableColumnWraper extends TableColumn<Object, String> {
	...
	public TableColumnWraper(nth.reflect.fw.gui.component.table.info.TableColumn tableColumn) {
		setMinWidth(100);
		setHeaderText(tableColumn);
		setCellValueFactory(new CellValueFactory(tableColumn));
	}

	private void setHeaderText(nth.reflect.fw.gui.component.table.info.TableColumn tableColumn) {
