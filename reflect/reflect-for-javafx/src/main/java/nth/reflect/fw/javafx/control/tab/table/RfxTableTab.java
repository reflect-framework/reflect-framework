...
public class RfxTableTab extends Tab implements nth.reflect.fw.ui.tab.table.TableTab {
	...
	public RfxTableTab(UserInterfaceContainer userInterfaceContainer, Object methodOwner,
	...
	protected void onTableRowSelect(int x, int y) {
		Collection<Item> menuItems = new TableRowMenuItems(RfxTableTab.this);
