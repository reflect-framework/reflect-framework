...
public class VerticalFlingScroller implements ReflectJavaFxControl {
	...
	public VerticalFlingScroller(Node node, ReadOnlyDoubleProperty totalContentHeightProperty) {
		this.node = node;
