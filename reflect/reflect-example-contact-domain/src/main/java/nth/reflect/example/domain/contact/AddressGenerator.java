...
import nth.reflect.util.random.generator.address.RandomAddress;
...
public class AddressGenerator extends RandomGenerator<List<Address>> {
	...
	private final nth.reflect.util.random.generator.address.AddressGenerator addressGenerator;
