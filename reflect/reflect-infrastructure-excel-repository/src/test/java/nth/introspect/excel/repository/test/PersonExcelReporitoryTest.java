...
public class PersonExcelReporitoryTest {
	...
	public void setUp() throws Exception {
		DependencyInjectionContainer container = new IntrospectApplicationForJUnit()
				.addInfrastructureClass(PersonExcelRepository.class).createContainer();
	...
	public void readFromTableNonExistingSheetTest() throws Exception {
		personExcelRepository.readFromTable(new PersonExcelReader(excelFile,
				"NONE EXISITING SHEET NAME", PersonExcelReader.COLUMN_NAMES));
	}

	@Test(expected = ColumnNamesNotFoundException.class)
	public void readFromTableNonExistingColumnName() throws Exception {
		String[] columnNames = new String[] { PersonExcelReader.NAME,
				PersonExcelReader.NUMBER_OF_CHILDREN, PersonExcelReader.BIRTHDAY,
				PersonExcelReader.WEIGHT, "BOGUS_COLUMN" };
		personExcelRepository.readFromTable(new PersonExcelReader(excelFile,
				PersonExcelReader.PERSONS_SHEET, columnNames));
	}

	@Test
	public void readFromTableObjectsTest() throws Exception {
		List<Person> persons = personExcelRepository
				.readFromTable(new PersonExcelReader(excelFile));
	...
	public void writeAsTableTest() throws Exception {
		...
		XSSFWorkbook workbook = personExcelRepository.createWorkbook();
		workbook = personExcelRepository.writeAsTable(workbook, PersonExcelReader.PERSONS_SHEET,
