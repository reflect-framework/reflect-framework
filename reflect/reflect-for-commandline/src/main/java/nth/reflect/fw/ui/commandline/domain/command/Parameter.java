...
public class Parameter {
	...
	public Parameter(PropertyInfo propertyInfo) throws ReflectCommandLineException {
		...
		if (!types.containsKey(type)) {
			throw new ReflectCommandLineException("Property type " + type.getCanonicalName() + " is not supported for property " + propertyInfo.getSimpleName());
		}
	...
	public void parseArgument(Object parameter, String argument) throws ReflectCommandLineException {
		try {
			...
			throw new ReflectCommandLineException("Could not parse '" + argument + "' to a '" + type.getName() + "' for property " + propertyInfo.getSimpleName());
		}
	}
