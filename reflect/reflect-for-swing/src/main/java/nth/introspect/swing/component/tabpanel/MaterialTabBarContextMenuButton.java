...
public class MaterialTabBarContextMenuButton extends MaterialButton {
	...
	public MaterialTabBarContextMenuButton(MaterialStyle materialStyle) {
		super(materialStyle.getTabToolbarIconStyle().getIconColor(), materialStyle.getTabToolbarIconStyle().getPressedColor(), materialStyle.getTabToolbarIconStyle().getPadding(), materialStyle.getTabToolbarIconStyle().getSize(), FontAwesome.fa_ellipsis_v);
	}
