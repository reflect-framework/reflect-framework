...
public class IntrospectImage {
	...
	public static final String PATH = SCHEMA
			+ "://nth.introspect.ui.images.IntrospectImage/";
	...
	public static final String BUTTON_ROUND_ABOUT = PATH
			+ "button_round_about.png";// remove about.png???
	public static final String BUTTON_ROUND_QUIT = PATH
			+ "application_quit.png";
	public static final String BUTTON_ROUND_PLUS = PATH
			+ "button_round_plus.png";
	public static final String BUTTON_ROUND_MINUS = PATH
			+ "button_round_minus.png";
	public static final String BUTTON_ROUND_EXPAND = PATH
			+ "button_round_expand.png";
	public static final String BUTTON_ROUND_COLLAPSE = PATH
			+ "button_round_collapse.png";
	public static final String BUTTON_ROUND_CANCEL = PATH
			+ "button_round_close.png";
	...
	public static final String TABS_CLOSE_THIS = PATH
			+ "tab_menu_close_this.png";
	public static final String TABS_CLOSE_ALL = PATH + "tab_menu_close_all.png";
	public static final String TABS_CLOSE_OTHERS = PATH
			+ "tab_menu_close_other.png";
