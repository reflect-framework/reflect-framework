...
/**
 * FIXME: can we get rid of this class???
 * @author nilsth
 *
 */
...
public class ColorUtil {
	...
	public static Color blend(Color color1, Color color2, double ratio) {
		...
		Color color = new Color(rgb1[0] * r + rgb2[0] * ir, rgb1[1] * r + rgb2[1] * ir, rgb1[2] * r
				+ rgb2[2] * ir);
	...
	public static String getHexName(Color color) {
		...
		return ((rHex.length() == 2 ? "" + rHex : "0" + rHex)
				+ (gHex.length() == 2 ? "" + gHex : "0" + gHex) + (bHex.length() == 2 ? "" + bHex
				: "0" + bHex)).toUpperCase();
	}
	 ...
	 */
	public static double colorDistance(double r1, double g1, double b1, double r2, double g2,
			double b2) {
		double a = r2 - r1;
		double b = g2 - g1;
		double c = b2 - b1;
	...
	public static double colorDistance(double[] color1, double[] color2) {
		return ColorUtil.colorDistance(color1[0], color1[1], color1[2], color2[0], color2[1],
				color2[2]);
	}
	 ...
	 */
	public static boolean isDark2(double r, double g, double b) {
	 ...
	 * @return True if this is a "dark" color, false otherwise.
	 */
	public static boolean isDark2(Color color) {
		float r = color.getRed() / 255.0f;
		float g = color.getGreen() / 255.0f;
		float b = color.getBlue() / 255.0f;

		return isDark2(r, g, b);
	}
	 ...
	 * @return
	 */
	public static Color transparency(Color color, double transparency) {
		return new Color(color.getRed(), color.getGreen(), color.getBlue(),
				(int) (transparency * 255 + 0.5));
	}
