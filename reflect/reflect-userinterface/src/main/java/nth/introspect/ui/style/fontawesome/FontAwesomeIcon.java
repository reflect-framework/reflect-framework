...
public class FontAwesomeIcon implements Icon {
    ...
    static {
        try {
        	InputStream stream = TestFontAwsome.class.getResourceAsStream(FONT_RESOURCE_PATH);
    ...
    public FontAwesomeIcon(String key) {
        this(FontAwesome.get(key));
    }
    ...
    public void paintIcon(Component c, Graphics g, int x, int y) {
        synchronized (LOCK) {
            if (buffer == null) {
                ...
                g2.drawString(String.valueOf(id.character()), 0, sy);
