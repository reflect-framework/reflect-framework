...
/**
 * 
 * Introspect is a light weight <a
 * href="http://en.wikipedia.org/wiki/Java_(programming_language)">Java</a> <a
 * href="http://en.wikipedia.org/wiki/Application_framework">Application
 ...
 * interface code. This means is that the Introspect Framework is ideal to learn
 * programming (e.g. at schools), rapid prototyping or rapid development.<br>
 * <br>
 * The Introspect framework provides different user interface implementations
 * that you can use for:
 * <ul>
 * <li>The desktop (based on <a
 * href="http://en.wikipedia.org/wiki/Swing_(Java)">Swing</a>)</li>
 * <li>Mobile devices (based on <a
 * href="http://en.wikipedia.org/wiki/Android_(operating_system)">Android</a>)</li>
 * <li>The web (based on <a
 * href="http://en.wikipedia.org/wiki/Vaadin">Vaadin</a>)</li>
