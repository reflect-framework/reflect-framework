 ...
 * 
 *Almost everyday new
 * libraries, frameworks and tools are being released by the developer
 * community, many of which reinvent the wheel.<br>
 * <br>
 ...
 * frameworks out there? <h3>Reason 1: Because its fun</h3> Probably the best
 * reason ever! <h3>Reason 2: Because I wanted to learn</h3> The journey of
 * developing yet another framework has thought me more than I could have
 * learned implementing an existing framework. Specifically on how other
 * frameworks solved issues that I run into. <h3>Reason 3: Because I wanted to
 * do it better</h3> I love the thoughts behind the <a
 * href="http://nakedobjects.codeplex.com/">Naked Objects Framework</a> (for <a
 ...
 * personally dislike which I tried to do better in the Introspect framework.
 * Note that what I dislike does not mean its wrong!
 * <ul>
