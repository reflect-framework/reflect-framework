...
public class PersonExcelReporitoryTest {
	...
	public void readFromTableNoFileTest() throws Exception {
		File excelFile = null;
		personExcelRepository.readFromTable(excelFile, new PersonExcelReader());
	}

	@Test(expected = FileNotFoundException.class)
	public void readFromTableNoneExistingFileTest() throws Exception {
		File excelFile = new File("C:/Users/nilsth/My Java/Workspace Introspect/IntrospectDataAccessExcel/src/nth/introspect/dataaccess/excel/test/DOES_NOT_EXIST.xlsx");
		personExcelRepository.readFromTable(excelFile, new PersonExcelReader());
	}
	...
	public void readFromTableNoneExcelFileTest() throws Exception {
		File excelFile = new File(
				"C:/Users/nilsth/My Java/Workspace Introspect/IntrospectDataAccessExcel/src/nth/introspect/dataaccess/excel/test/Person.java");
		personExcelRepository.readFromTable(excelFile, new PersonExcelReader());
	}

	@Test(expected=CouldNotFindSheetsException.class)
	public void readFromTableNonExistingSheetTest() throws Exception {
		personExcelRepository.readFromTable(excelFile, new PersonExcelReader("NONE EXISITING SHEET NAME", PersonExcelReader.COLUMN_NAMES));
	}
	...
	public void readFromTableNonExistingColumnName() throws Exception {
		...
		personExcelRepository.readFromTable(excelFile, new PersonExcelReader(PersonExcelReader.PERSONS_SHEET, columnNames));
	}

	@Test
	public void readFromTableObjectsTest() throws Exception {
		List<Person> persons = personExcelRepository.readFromTable(excelFile, new PersonExcelReader());
	...
	public void writeAsTableTest() throws Exception {
		...
		persons=personExcelRepository.readFromTable(excelFile, new PersonExcelReader());
		assertEquals(2, persons.size());
