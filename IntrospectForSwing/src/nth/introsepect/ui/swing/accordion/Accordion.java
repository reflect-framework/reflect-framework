...
/**
 * A Accordion provides a component that is similar to a JTabbedPane, but instead of maintaining
...
public class Accordion extends JPanel implements ActionListener
{
  ...
  public void addBar(ServiceObjectBar serviceObjectBar) {
	  serviceObjectBar.getButton().addActionListener( this );
	    this.bars.put( serviceObjectBar.getMethodOwnerItem().getText(), serviceObjectBar );
	    render();
	}
